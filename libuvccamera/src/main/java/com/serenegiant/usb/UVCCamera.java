...
public class UVCCamera {
    ...
    public synchronized void open(final UsbControlBlock ctrlBlock) {
        ...
        try {
            ...
            Log.v(TAG, "id_camera=" + mNativePtr);
            Log.v(TAG, "venderId=" + mCtrlBlock.getVenderId());
            Log.v(TAG, "productId=" +  mCtrlBlock.getProductId());
            Log.v(TAG, "fileDescriptor=" + mCtrlBlock.getFileDescriptor());
            Log.v(TAG, "busNum=" +  mCtrlBlock.getBusNum());
            Log.v(TAG, "devAddr=" +  mCtrlBlock.getDevNum());
            Log.v(TAG, "usbfs=" +  getUSBFSName(mCtrlBlock));
